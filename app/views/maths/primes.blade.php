...
@section('content')
    <div ng-app="primes">
        ...
        <p>For more info on prime numbers and Ulam sprials <a href="http://www.youtube.com/watch?v=3K-12i0jclM">watch this
            video</a> or <a href="">this video</a> by <a href="">numberphile</a>.</p>

        <p>Enter a range of values to spiral from and up to, the prime numbers will be highlighted:</p>
